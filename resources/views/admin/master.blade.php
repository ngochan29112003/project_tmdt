...
<?php
$checkQuyen = \Illuminate\Support\Facades\DB::table('phanquyenadmin')
...
$ttDangNhap = \Illuminate\Support\Facades\DB::table('taikhoan')
    ->where('MaTK', session('MaTK'))
    ->first();
$userPermissions = $checkQuyen->pluck('MaQuyen')->toArray();
//    dd($userPermissions)
        ...
        <div class = "container-fluid">
            ...
            <h1 class = "navbar-brand navbar-brand-autodark pb-0">
                <a href = "{{route('admin-home')}}">
                    <img src = "{{asset('asset/img/logo-admin.png')}}" width = "100" height = "auto"> </a>
            </h1>
            ...
            <div class = "collapse navbar-collapse" id = "sidebar-menu">
                <ul class = "navbar-nav pt-lg-3">
                    @if(in_array(1, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-danh-muc')}}">
                                    ...
                                    </span> <span class = "nav-link-title">Quản lý danh mục</span> </a>
                        </li>
                    @endif

                    @if(in_array(2, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-hang-san-xuat')}}">
                                        <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                        ...
                                        </span> <span class = "nav-link-title">Quản lý hãng sản xuất</span> </a>
                        </li>
                    @endif

                    @if(in_array(3, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-san-pham')}}">
                                        <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                        ...
                                        </span> <span class = "nav-link-title">Quản lý sản phẩm</span> </a>
                        </li>
                    @endif

                    @if(in_array(4, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-don-hang')}}">
                                        <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                        ...
                                        </span> <span class = "nav-link-title">Quản lý đơn hàng</span> </a>
                        </li>
                    @endif

                    @if(in_array(5, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-van-chuyen')}}">
                                <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                </span> <span class = "nav-link-title">Quản lý vận chuyển</span> </a>
                        </li>
                    @endif

                    @if(in_array(7, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-binh-luan')}}">
                                <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                ...
                                </span> <span class = "nav-link-title">Quản lý bình luận</span> </a>
                        </li>
                    @endif

                    @if(in_array(8, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-khuyen-mai')}}">
                                <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                ...
                                </span> <span class = "nav-link-title">Khuyến mãi</span> </a>
                        </li>
                    @endif

                    @if(in_array(9, $userPermissions))
                        <li class = "nav-item">
                            <a class = "nav-link" href = "{{route('admin-danh-sach-khuyen-mai-vc')}}">
                                <span class = "nav-link-icon d-md-none d-lg-inline-block">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-dollar">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                </span> <span class = "nav-link-title">Khuyến mãi vận chuyển</span> </a>
                        </li>
                    @endif
                </ul>
            </div>
                ...
                <div class = "d-none d-md-flex">
                    ...
                    <div class = "nav-item dropdown d-none d-md-flex me-3">
                        <a href = "#" class = "nav-link px-0" data-bs-toggle = "dropdown" tabindex = "-1" aria-label = "Show notifications">
                            ...
                            <span class = "badge bg-red"></span> </a>
