                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            toastr.error("Duyệt không thành công.", "Operation Failed");
                        }
                    },
                    error: function (xhr) {
                        toastr.error("Đã xảy ra lỗi.", "Operation Failed");
                    }
                });
            }
        });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            toastr.error("Xóa không thành công.", "Operation Failed");
                        }
                    },
                    error: function (xhr) {
